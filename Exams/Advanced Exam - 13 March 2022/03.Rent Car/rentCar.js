...
let newArr = rentCar
// console.log(newArr.searchCar(["Volkswagen", "BMW", "Audi"],'BMW'))
// // console.log(newArr.searchCar(["Volkswagen", "BMW", "Audi"],'BMW','Audi'))
// // console.log(newArr.searchCar(["Volkswagen", "BMW", "Audi"],'Citroen'))
// console.log(newArr.calculatePriceOfCar("Citroen",2))
console.log(newArr.checkBudget(1,5,6))
console.log(newArr.checkBudget(1,5,4))
console.log(newArr.checkBudget(10,15,26))
console.log(newArr.checkBudget(10,5,66))
console.log(newArr.checkBudget(1,5,-6))
