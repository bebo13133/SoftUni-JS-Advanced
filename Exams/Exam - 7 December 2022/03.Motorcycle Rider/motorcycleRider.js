...
let newArr = motorcycleRider
console.log(newArr.motorcycleShowroom([125,250,600],125))

console.log(newArr.otherSpendings(['jacket'],['engine oil'],true))

console.log(newArr.otherSpendings(['jacket'],['engine oil'],false))
console.log(newArr.otherSpendings([],['engine oil'],true))
console.log(newArr.otherSpendings(['jacket',"helmet"],[],true))
console.log(newArr.otherSpendings(['jacket',"helmet"],['engine oil',"oil filter"],true))
console.log(newArr.otherSpendings(['jacket'],[],false))
