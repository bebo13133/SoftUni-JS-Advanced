class JobOffers {
  ...
  jobApplication(candidates) {
    ...
    candidates.forEach(line => {
      ...
      if (findName) {
        if (findName.yearsExperience < yearsExperience) findName.yearsExperience = yearsExperience
      }
      if (!findName) names.push(name), this.jobCandidates.push({ name, education, yearsExperience })
    });
