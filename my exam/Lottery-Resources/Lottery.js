...
let newArr = lottery
console.log(newArr.checkTicket([1,2,3,4,5,6],[1,2,3,4,5,6]))
console.log(newArr.checkTicket([1,2,3,4,5,6],[1,11,13,4,5,7]))
console.log(newArr.checkTicket([1,2,3,4,5,6],[1,21,3,4,5,7]))
